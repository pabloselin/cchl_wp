...
<div id="main-page" class="container_16 cf post-<?php echo $post->ID;?>">
    ...
    <div id="content" class="grid_12">
        ...
        <div class="accesos-rapidos filsa-2017">
        
        <?php 
            if(has_nav_menu( 'accesos-rapidos-filsa-2017') ):
                wp_nav_menu( array('theme_location'=> 'accesos-rapidos-filsa-2017') );
            endif;
        ?>
        ...
        <div class="eventos-destacados">
            ...
            <?php 
                ...
                $eventos = cchl_getmenus( 'eventos-destacados-filsa-2017' );
