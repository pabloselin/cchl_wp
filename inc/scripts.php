...
function cchl_styles() {
  ...
  wp_register_style( 'camara', get_bloginfo('template_url') . '/css/camara.9ad498d5.min.css', array(), CCHL_VERSION, 'screen' );
...
global $post;
  ...
  if(WP_ENV != 'development') {
    wp_register_script( 'camara', get_bloginfo('template_url') . '/js/camara.04c27d77.min.js', array('jquery'), CCHL_VERSION, true);
  } else {
