...
function cchl_styles() {
	...
	wp_register_style( 'cchlcss', get_bloginfo('template_url') . '/css/style-cchl.bf5c41eb.min.css', array(), '0.2', 'screen' );
...
if(!is_admin()) {
  ...
  wp_register_script( 'cchl_scripts', get_bloginfo('template_url') . '/js/cchl-scripts.7f47dd78.min.js', array('jquery', 'featherlight', 'masonry'));
