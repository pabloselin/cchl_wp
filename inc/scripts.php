...
function cchl_styles() {
  ...
  wp_register_style( 'mailchimp', '//cdn-images.mailchimp.com/embedcode/classic-081711.css' , array(), '0.1', 'screen');
	...
	wp_register_style( 'cchlcss', get_bloginfo('template_url') . '/css/style-cchl.9a696de4.min.css', array(), CCHL_VERSION, 'screen' );
...
global $post;
  ...
  wp_register_script( 'cchl_scripts', get_bloginfo('template_url') . '/js/cchl-scripts.05763b3a.min.js', array('jquery', 'featherlight', 'masonry'));
