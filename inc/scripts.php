...
function cchl_styles() {
	...
	wp_register_style( 'cchlcss', get_bloginfo('template_url') . '/css/style-cchl.18b797fa.min.css', array(), '0.2', 'screen' );
...
if(!is_admin()) {
  ...
  wp_register_script( 'cchl_scripts', get_bloginfo('template_url') . '/js/cchl-scripts.c1447574.min.js', array('jquery', 'featherlight', 'masonry'));
