...
function twentyten_continue_reading_link() {
	return ' <a href="'. get_permalink() . '" class="read_more">' . __( 'Siga Leyendo »', 'twentyten' ) . '</a>';
}
...
function excerpt($num) {
	...
	array_pop($excerpt);
	$excerpt = implode(" ",$excerpt).' <a class="read_more" href="'. get_permalink() . '">' . __( 'Siga leyendo »<span class="meta-nav"></span>', 'twentyten' ) . '</a>';
	echo '<p>'.$excerpt.'</p>';
}
