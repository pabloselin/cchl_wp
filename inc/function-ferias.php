...
function cchl_bsferiaredirect($original_template) {
	global $post;
	$using_bsferiatemplate= cchl_get_topmost_parent_template($post->ID, 'templates/bs-plantilla-feria.php');
	...
	if($using_bsferiatemplate) {
		return  get_template_directory() .  '/templates/bs-plantilla-feria.php';
