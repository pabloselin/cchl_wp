<body <?php body_class();?> id="filij-2014">
	...
	<header class="filsa-header">
		<a href="<?php echo get_permalink(31817);?>"><img src="<?php bloginfo('template_url');?>/img/filij2014/headerfilij_2.png" alt="FILIJ 2014" /></a>
	</header>