...
<?php endif;?>
        ...
        <!-- <a class="header__logofil2016" href="<?php echo get_permalink(60494);?>"><img src="<?php echo get_bloginfo('template_url');?>/img/filij-2016/banner_header_filij_2016.png" alt="<?php echo get_the_title(60494);?>"></a> -->
