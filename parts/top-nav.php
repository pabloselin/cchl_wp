...
<?php endif;?>
        ...
        <a class="header__logofil2016" href="<?php echo get_permalink(60131);?>"><img src="<?php echo get_bloginfo('template_url');?>/img/banner_flpa2016_movil.png" alt="<?php echo get_the_title(60131);?>"></a>
