...
<?php get_template_part('parts/clean-sidebar');?>
    ...
    <?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
        ...
        <p style="margin-bottom:12px;">
          <a href="<?php bloginfo('template_url');?>/img/filsa2016/mapa/mapa_full_01.png"><img class="mapa-preview" src="<?php bloginfo('template_url');?>/img/filsa2016/mapa/mapa_preview_01.png" alt="Mapa FILSA 2016"></a>
          <a class="linkimgmapa" target="_blank" href="<?php bloginfo('template_url');?>/img/filsa2016/mapa/mapa_full_01.png">Clic en la imagen para ver el mapa en alta resolución.</a>
        </p>
